    ...
    <div className="flex h-auto w-full items-center overflow-hidden text-primaryColor">
      <div className="w-full xl:w-2/3">
        ...
        <p className="pb-4 pl-10 text-lg">
          My name is <span className="text-lg text-themePrimaryColor">Febin P Biju</span> and I am an {' '}
          <span className="text-lg text-themePrimaryColor">Frontend Developer </span>
